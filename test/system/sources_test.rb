...
class SourcesTest < ApplicationSystemTestCase
  ...
  test "should create source" do
    ...
    fill_in "Bio", with: @source.bio
    fill_in "Byear", with: @source.byear
    fill_in "Dyear", with: @source.dyear
    fill_in "Fname", with: @source.fname
    fill_in "Lname", with: @source.lname
